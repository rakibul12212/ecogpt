    ...
    <Container>
      <div className="grid grid-cols-2 gap-4 p-10">
        <div className="border-1 border-gray-200 rounded-md p-4">
          ...
          <br />
          <p className="text-sm">
            Receive custom prompts that reflect your writing style, helping you
            push past creative blocks and
          </p>
        </div>
        <div className="border-1 border-gray-200 rounded-md p-4">
          <p className="font-bold text-sm txt-gray-700">
        ...
        <div className="border-1 border-gray-200 rounded-md p-4">
          ...
          <br />
          <p className="text-sm">
            Generate catchy, clever captions for your photos or videos, perfect
