...
const HeroSection = () => {
  return (
    <Container className="ps-5 md:ps-28 2xl:ps-28">
      <div className="lg:max-w-2xl 2xl:max-w-4xl mx-4 sm:mx-8 md:mx-60 h-[300px] md:h-[200px] 2xl:h-[500px] overflow-y-auto mt-5 md:mt-2 2xl:mt-16 relative z-10">
